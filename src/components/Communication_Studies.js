    ...
    <div style={{ display: 'flex', height: '80vh', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{background:'none', width: '85%', display: 'flex', flexDirection: 'column'}}>
            <div style={{background:'none', display: 'flex', flexDirection: 'column'}}>
                ...
                <p style={{color: '#FFFFFF'}} class="bannerContent-res">If you are interested and want to know more
        ...
        <div id="carouselCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src={require("../assets/images/Communication_Studies/CS-img-4.png")}
                ...
                <div class="carousel-item">
                    <img src={require("../assets/images/Communication_Studies/CS-img-5.png")}
                        class="d-block w-100 carousel-image" alt=""/>
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src={require("../assets/images/Communication_Studies/CS-img-6.png")}
                        class="d-block w-100 carousel-image" alt=""/>
                    <div class="carousel-caption d-none d-md-block">
...
<div class="row bgColor">
    ...
    <div class="col-sm-5">
        <img class="image2" src={require("../assets/images/Communication_Studies/CS-img-7.png")} alt=""/>
    </div>
</div>

<div class="CS-Section-6">
    <div class="row">
        <div class="col-sm-5">
            <img class="CS-Section-6-img" src={require("../assets/images/Communication_Studies/CS-img-8.png")} alt=""/>
        </div>
        <div class="col-sm-7">
            <br />
            <div class="CS-Section-6-right">

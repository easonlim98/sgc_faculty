...
const Institution = () => {
    return (
        <>
            ...
            <div class="container" id="institution-container">
                <div class="row py-5" id="institution-row-container">
                    <div class="col-sm row justify-content-end pr-5" id="institution-img-container">
                        <img src="https://www.segi.edu.my/wp-content/uploads/2021/06/kota-damansara-1.jpg" id="institution-img" />
                    </div>
                    <div class="col-sm row justify-content-start pl-5" id="institution-img-container">
                        <img src="https://www.segi.edu.my/wp-content/uploads/2021/06/subang-jaya.jpg" id="institution-img" />
                    </div>
                </div>
                <div class="row pb-5" id="institution-row-container">
                    <div class="col-sm row justify-content-end pr-5" id="institution-img-container">
